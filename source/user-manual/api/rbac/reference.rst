...
lists:read
~~~~~~~~~~~~~~~~~~~~~~~~~~
- :api-ref:`GET /lists <operation/api.controllers.cdb_lists_controller.get_lists>` (`list:path`_)
- :api-ref:`GET /lists/files <operation/api.controllers.cdb_lists_controller.get_lists_files>` (`list:path`_)
...
- :api-ref:`GET /rules/files/{filename} <operation/api.controllers.rules_controller.get_rule_file>` (`rule:file`_)
...
rules:update
~~~~~~~~~~~~~~~~~~~~~~~~~~
- :api-ref:`PUT /rules/files/{filename} <operation/api.controllers.rules_controller.upload_rule_file>` (`rule:file`_)

rules:delete
~~~~~~~~~~~~~~~~~~~~~~~~~~
- :api-ref:`DELETE /rules/files/{filename} <operation/api.controllers.rules_controller.delete_rule_file>` (`rule:file`_)
